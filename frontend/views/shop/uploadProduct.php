...
/* @var \frontend\models\CartForm $cartForm */
...
<section
	...
	<!-- Section Title Start -->
	<div
		x-data="{ sectionTitle: `Pembayaran`, sectionTitleText: `Jelajahi kemudahan pembayaran yang cepat dan aman melalui transaksi QRIS di halaman pembayaran kami, yang memastikan pengalaman belanja Anda tetap lancar dan terpercaya.`}"
	>
		<div class="animate_top bb ze rj ki xn vq">
			...
			<p
				class="bb on/5 wo/5 hq"
				x-text="sectionTitleText"></p>
		</div>
		...
		<div class="i va bb ye ki xn wq jb mo">
			...
			<div class="tc uf sn tf rn un zf xl:gap-10">
				<div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
					...
					<div class="fb">
						<h4 class="wj kk wm cc">Scan QRIS</h4>
						<img
							src="images/northcenter1995.png"
							alt="Support Email"/>
					</div>
				...
				<div class="animate_top w-full nn/5 vo/3 vk sg hh sm yh tq">
					<div class="tc sf yo ap zf ep qb">
						<div class="vd to/2">
							<?= $form->field($cartForm, 'fullName', [
								'labelOptions' => ['class' => 'rc ac'],
								'inputOptions' => ['class' => 'vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi', 'placeholder' => 'Nama'],
							])->label('Nama Lengkap') ?>
						</div>

						<div class="vd to/2">

							<?= $form->field($cartForm, 'phoneNum', [
								'labelOptions' => ['class' => 'rc ac'],
								'inputOptions' => ['class' => 'vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi', 'placeholder' => 'Nomor Telpon'],
							])->label('Nomor Telpon') ?>
						</div>
					</div>
					...
					<div class="tc sf yo ap zf ep qb">
						<div class="vd to/2">
							...
							<?= $form->field($cartForm, 'address', [
								'labelOptions' => ['class' => 'rc ac'],
								'inputOptions' => ['class' => 'vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi', 'placeholder' => 'Ruang Kelas'],
							])->label('Ruang Kelas') ?>
						</div>

						<div class="vd to/2">

							<?= $form->field($cartForm, 'buktiPembayaran', [
								'labelOptions' => ['class' => 'rc ac'],
								'inputOptions' => ['class' => 'vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi'],
							])->fileInput()->label('Upload Bukti Pembayaran') ?>
<!--							<label-->
<!--								class="rc ac"-->
<!--								for="subject">Upload Bukti Pembayaran</label>-->
<!--							<input-->
<!--								type="file"-->
<!--								for="subject"-->
<!--								id="subject"-->
...
<!--							/>-->
					...
					<div class="fb">
						<?= $form->field($cartForm, 'pesan', [
							'labelOptions' => ['class' => 'rc ac'],
							'inputOptions' => ['class' => 'vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi','rows' => 4, 'placeholder' => 'Pesan'],
						])->textarea()->label('Pesan') ?>
					</div>

					<div class="tc xf">
						<?= Html::submitButton('Pembayaran Selesai', ['class' => 'vc rg lk gh ml il hi gi _l'])?>
					</div>
				</div>
			</div>
			<?php ActiveForm::end() ?>
