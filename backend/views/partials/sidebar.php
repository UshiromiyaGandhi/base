...
>
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="index.html">
            <img src="./images/logobase.png" width="60" alt="Logo"/>
        </a>
    ...
    >
	    <?php
	    if ($this->params['breadcrumbs'] ?? false) {
        ...
        >
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
					...
					<?php if (Yii::$app->user->can('accessAdmin')): ?>
                   ...
                   page === "analytics" || page === "stocks") }'
                    ...
                    <li>
                        <a
                                class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                href="#"
                                @click.prevent='selected = (selected === "Shop" ? "":"Shop")'
                                :class='{ "bg-graydark dark:bg-meta-4": (selected === "Shop") || (page === "shop") }'
                        >
                            <svg
                                    class="fill-current"
                                    width="18"
                        ...
                        <div
                                class="translate transform overflow-hidden"
                                :class="(selected === 'Shop') ? 'block' :'hidden'"
                        >
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                               <li>
									<?= Html::a(
                    ...
                    <li>
                        ...
                        >
                            <ul class="mb-3 mt-4 flex flex-col gap-2 pl-6">
                                <li>
									<?= Html::a('Sign In', Url::base() . '/index.php?r=admin/user/login', ['class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white']) ?>
                                </li>
                                <li>
									<?= Html::a('Sign Up', Url::base() . '/index.php?r=admin/user/signup', ['class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white']) ?>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
