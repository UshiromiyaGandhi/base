            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        ...
                        >
                          <?php
                          $current = array_column($this->params['breadcrumbs'], 'label') ?: [];
                          $current[] = end($this->params['breadcrumbs']);
//                          print_r($current);
//                          die
                          ?>
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/route'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Routes', $current) ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/permission'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Permissions', $current) ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/menu'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Menus', $current) ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/role'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Roles', $current) ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/assignment'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Assignments', $current) ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
			                            <?= Html::a(
				                            ...
				                            ['/admin/rule'],
				                            [
					                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Rules', $current ) ? 'text-white' : ''),
				                            ]
			                            ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/user'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (in_array('Users', $current ) ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                            </ul>
...
<!--                                    >Sign In</a-->
<!--                                    >-->
                                    <?= Html::a('Sign In', ['user/login'], ['class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white']) ?>
                                </li>
                                <li>
<!--                                    <a-->
<!--                                            class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"-->
...
<!--                                    >Sign Up</a-->
<!--                                    >-->
	                                <?= Html::a('Sign Up', ['user/signup'], ['class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white']) ?>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
