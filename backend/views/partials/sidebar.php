                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/route'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (end($this->params['breadcrumbs']) === 'Routes' ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/permission'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (end($this->params['breadcrumbs']) === 'Permissions' ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/menu'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (end($this->params['breadcrumbs']) === 'Menus' ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/role'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (end($this->params['breadcrumbs']) === 'Roles' ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/assignment'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (end($this->params['breadcrumbs']) === 'Assignments' ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                                <li>
                                    <?= Html::a(
                                        ...
                                        ['/admin/user'],
                                        [
                                            'class' => 'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' . (end($this->params['breadcrumbs']) === 'Users' ? 'text-white' : ''),
                                        ]
                                    ) ?>
                                </li>
                            </ul>
