        ...
        >
            ...
            >
                ...
                >
                    ...
                    Route
                    ', Url::base() . '/index.php?r=admin/route', [
                    ...
                    Permission
                    ', Url::base() . '/index.php?r=admin/permission', [
																				'class' => ['flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base']
																			])
																			?>
                                    </li>
                    ...
                    Menu
                    ', Url::base() . '/index.php?r=admin/menu', [
																				'class' => ['flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base']
																			])
																			?>
                                    </li>
                    ...
                    Role
                    ', Url::base() . '/index.php?r=admin/role', [
																				'class' => ['flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base']
																			])
																			?>
                                    </li>
                    ...
                    Assignment
                    ', Url::base() . '/index.php?r=admin/assignment', [
																				'class' => ['flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base']
																			])
																			?>
                                    </li>
                    ...
                    User
                    ', Url::base() . '/index.php?r=admin/user', [
																				'class' => ['flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base']
																			])
																			?>
                                    </li>
                    ...
                    <span class="block text-xs font-medium">UX Designer</span>
                        ...
                        <span class="h-12 w-12 rounded-full"><img src="./images/user/user-01.png" alt="User"/></span>
                    </div>
                </div>
            </header>
            <!--        Header End-->
